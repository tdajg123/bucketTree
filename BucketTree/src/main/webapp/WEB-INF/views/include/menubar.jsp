				...
				<ul class="nav navbar-left">
					<li class="dropdown user user-menu"><a href="#"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="#"><i class="fa fa-fw fa-gear"></i> 정보관리</a></li>
							<li class="divider"></li>
							<li><a href="/BucketTree/logout"><i class="fa fa-fw fa-power-off"></i>
									로그아웃</a></li>
						</ul></li>
				</ul>
				<!-- 포인트  -->
...
<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
    ...
    <div class="box box-solid box-default">
    	...
    	<div class="box-list">
	    	<div class="box-body">
	    		<img src="/BucketTree/images/user1-128x128.jpg" class="user-image" alt="User Image">
	         	<h4> 백승호</h4>
	    	</div>
	    	<div class="box-body">
	    		<img src="/BucketTree/images/user1-128x128.jpg" class="user-image" alt="User Image">
...
<script type="text/javascript"
	src="/BucketTree/js/jquery.dlmenu.js"></script>
<script>
	$(function() {
		$('#dl-menu-1').dlmenu();
	});
...
<script src="/skhu/resources/dist/js/app.min.js"></script>
<script src="/skhu/resources/dist/js/demo.js"></script>